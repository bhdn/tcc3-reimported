...
from tcc3.config import TCC3Config
from tcc3.facade import TCC3Facade
...
class TCC3Command(object):

    descr = "The base tcc3 command."
    usage = "[options] [args]"
    ...
    def setup_logging(self, config, opts, args):
        ...
        # configparser
        format = config.tcc3.log_format.replace("$", "%")
