...
é apresentado na figura \ref{fig:diagramaclasses1}.  Para o caso de SVMs, será
usada a técnica de um-contra-todos (descrita na seção \ref{sec:svmmulti}), que
consiste na criação múltiplas instâncias de SVM, representando a identificação
de uma classe.
