...
\figinfo{Um \emph{host} e várias máquinas virtuais (\emph{guests})}
...
\figinfo{Dois hóspedeiros e carga de CPU aceitável das MVs}
...
\figinfo{Dois hóspedeiros e carga das MVs desbalanceada entre eles}
