...
hospedeiro que tenha condições de tratar aquela demanda. Este software na
forma de um \emph{daemon}, ou seja, um serviço do sistema independente aos
serviços de virtualização. Este poderá estar instalado em qualquer uma das
máquinas hospedeiras ou até mesmo em uma máquina separada, providas as
credenciais de acesso para a \libvirt{}.
...
O projeto será implementado na linguagem \emph{Python}
