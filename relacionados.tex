...
$e_t$ representa um ruído no modelo. Utilizando a técnica de \emph{Yule-Walker} é
...
informações a respeito do \emph{software} que está sendo analisado e, então, gera um
“esqueleto” da mesma, o qual será executado em um ambiente que será
avaliado. Para avaliação de desempenho foram usadas ferramentas do conjunto
\emph{NAS Benchmark}, com esqueletos de tempo de execução variando de 0,5 a
10 segundos.  Com exceção do esqueleto de 0,5 segundos, os outros tiveram
uma taxa de erro de predição média de 6,7\%. 
...
externamente, sem executar \emph{software} dentro do sistema observado, o que permite
